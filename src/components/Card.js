...
export default function CardBooks(props) {
    ...
    return (
        <Link to={`/book/${nombre}`} state={{ book: book }} style={{ width: "10%" , borderRadius: 10, alignItems: "center", justifyContent: "center", display: "flex", flexDirection: "column", boxShadow: '4px 4px 8px rgba(0, 0, 0, 0.25)', color: "inherit", textDecoration: "none" }}>
            <div style={{ backgroundColor: colors.white, borderRadius: 10, alignItems: "center", justifyContent: "center", display: "flex", flexDirection: "column" }}>
                <Image src={imagen} width={"100%"}  style={{ borderRadius: 10 }}></Image>
