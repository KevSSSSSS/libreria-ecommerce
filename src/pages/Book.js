...
export default function Book() {
    ...
    const { imagen, nombre, autor, sipnosis, precio, stock } = state?.book;
    return (
        <>
            <MasterPage />
            <NavTabMenu />
            <div style={{ alignItems: "center", justifyContent: "center", display: "flex" }}>
                <div style={{ margin: 20, width: "60%", padding: 20, height: "80vh", display: "flex" }}>
                    <div style={{ width: "20%" }}>
                        <Image src={imagen} width={"100%"} height={"280vh"} style={{ borderRadius: 10 }}></Image>
                    </div>
                    <div style={{ width: "80%", display: "flex", flexDirection: "column", alignItems: "center" }}>
                        <h4 style={{ fontFamily: fontFamily.primary }}>{nombre}</h4>
                        ...
                        <br />
                        <span>Sipnosis: </span>
                        <p style={{ margin: 24, fontFamily: fontFamily.primary }}>{sipnosis}</p>
